...
//            ->from(new Address('s.hadef@outlook.fr', 'Challenge'))
...
//        dd($this->replyTo);
       ...
       //Configuration de l'API Walid
        ...
        $config = Configuration::getDefaultConfiguration()->setApiKey('api-key', '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');
        ...
        $sendSmtpEmail = new SendSmtpEmail([
            'to' => [new SendSmtpEmailTo(['email' => 's.hadef@outlook.fr'])],
            'subject' => $subject,
            'htmlContent' => $content,
            'sender' => ['name' => 'Challenge', 'email' => 's.hadef@outlook.fr', 'replyTo' => $this->replyTo],
